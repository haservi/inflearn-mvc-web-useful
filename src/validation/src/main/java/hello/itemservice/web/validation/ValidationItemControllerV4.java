...
public class ValidationItemControllerV4 {
    ...
    @PostMapping("/add")
    public String addItem(@Validated @ModelAttribute("item") ItemSaveRequestDto item, BindingResult bindingResult,
...
//    @PostMapping("/add")
    ...
    public String edit(@PathVariable Long itemId, @Validated @ModelAttribute("item") ItemUpdateRequestDto item,
